#############################################################################
# Makefile for building: qq_s
# Generated by qmake (2.01a) (Qt 4.8.1) on: ?? 9? 6 11:31:07 2019
# Project:  qq_s.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile qq_s.pro
#############################################################################
...
Makefile: qq_s.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile qq_s.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/qq_s1.0.0 || $(MKDIR) .tmp/qq_s1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qq_s1.0.0/ && $(COPY_FILE) --parents dialog.h .tmp/qq_s1.0.0/ && $(COPY_FILE) --parents main.cpp dialog.cpp .tmp/qq_s1.0.0/ && $(COPY_FILE) --parents dialog.ui .tmp/qq_s1.0.0/ && (cd `dirname .tmp/qq_s1.0.0` && $(TAR) qq_s1.0.0.tar qq_s1.0.0 && $(COMPRESS) qq_s1.0.0.tar) && $(MOVE) `dirname .tmp/qq_s1.0.0`/qq_s1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qq_s1.0.0
